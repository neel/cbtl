...
crn::blocks::params::passive crn::blocks::params::passive::construct(const crn::blocks::access& last, const crn::keys::identity::public_key& pub, const CryptoPP::Integer& gaccess, const crn::keys::identity::private_key& master){
    CryptoPP::Integer h = crn::utils::sha512::digest(gaccess, CryptoPP::Integer::UNSIGNED);
    auto Gp = pub.G().Gp(), Gp1 = pub.G().Gp1();
    auto hash      = crn::utils::sha512::digest(Gp.Exponentiate(last.passive().forward(), master.x()), CryptoPP::Integer::UNSIGNED);

...
struct params{
    ...
    struct passive{
        ...
        static passive construct(const crn::blocks::access& last, const crn::keys::identity::public_key& pub, const CryptoPP::Integer& gaccess, const crn::keys::identity::private_key& master);
    ...
    params(const active& active, const crn::blocks::access& passive_last, const keys::identity::public_key& passive_pub, const keys::identity::private_key& master, const CryptoPP::Integer& gaccess, const boost::posix_time::ptime& requested);

...
#ifndef cbtl_MATH_VECTOR_H
#define cbtl_MATH_VECTOR_H
...
class vector{
    ...
    public:
        vector(const cbtl::math::group& G): _G(G) {}
        vector(const vector<N>& other) = default;
        template <typename... Args>
        vector(const cbtl::math::group& G, const Args&... args): _G(G), _values({args...}) {}
        ...
        const cbtl::math::group& G() const { return _G; }
};
